...
import com.okysoft.annictim.infra.api.model.response.Review
...
class ReviewsAdapter: RecyclerView.Adapter<BindingViewHolder<ItemReviewBinding>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BindingViewHolder<com.okysoft.annictim.databinding.ItemReviewBinding> {
